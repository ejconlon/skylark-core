...
instance Txt Metric where
  txt (Counter g b v) = sformat (stext % "." % stext % ":" % stext % "|c") (txt g) (txt b) (txt v)
  txt (Timer   g b v) = sformat (stext % "." % stext % ":" % stext % "|t") (txt g) (txt b) (txt v)
  txt (Gauge   g b v) = sformat (stext % "." % stext % ":" % stext % "|g") (txt g) (txt b) (txt v)
  txt (Set     g b v) = sformat (stext % "." % stext % ":" % stext % "|s") (txt g) (txt b) (txt v)
